// Value helpers and the escape hatch. Dates come from the runner, not the
// page, so a scenario can build "yesterday" without importing anything; and
// evaluate() is the last resort for state the DOM does not expose — here the
// canvas cell, whose score never reaches the accessibility tree.
